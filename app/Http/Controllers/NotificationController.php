    ...
    try {
        ...
        $projectRequests = DB::table('project_endorsement_statuses as pes')
            ...
            ->select('pes.id', 'pes.created_at', 'requestor.google_id as requestor_google_id', 
                    'requestor.name as requestor_name', 'p.title as project_title')
            ->get();
        ...
        $experienceRequests = DB::table('experience_endorsement_statuses as ees')
            ...
            ->orderBy('ees.created_at', 'desc')
            ->select('ees.id', 'ees.created_at', 'requestor.google_id as requestor_google_id', 
                    'requestor.name as requestor_name', 'e.work_title', 'c.company_name')
            ->get();
        ...
        $skillRequests = DB::table('skill_endorsement_statuses as ses')
            ...
            ->select('ses.id', 'ses.created_at', 'requestor.google_id as requestor_google_id',
                    'requestor.name as requestor_name', 's.title as skill_title')
            ->get();
        ...
        $achievementRequests = DB::table('achievement_endorsement_statuses as aes')
            ...
            ->orderBy('aes.created_at', 'desc')
            ->select('aes.id', 'aes.created_at', 'requestor.google_id as requestor_google_id', 
                    'requestor.name as requestor_name', 'a.title as achievement_title', 'a.issued_by')
            ->get();
        ...
        $projectResponses = DB::table('project_endorsement_statuses as pes')
            ...
            ->select('pes.id', 'pes.updated_at as created_at', 'endorser.google_id as endorser_google_id',
                    'endorser.name as endorser_name', 'p.title as project_title', 'pes.endorsement_status_id')
            ->get();
        ...
        $experienceResponses = DB::table('experience_endorsement_statuses as ees')
            ...
            ->select('ees.id', 'ees.updated_at as created_at', 'endorser.google_id as endorser_google_id',
                    'endorser.name as endorser_name', 'e.work_title', 'c.company_name', 'ees.experience_status_id as endorsement_status_id')
            ->get();
        ...
        $skillResponses = DB::table('skill_endorsement_statuses as ses')
            ...
            ->select('ses.id', 'ses.updated_at as created_at', 'endorser.google_id as endorser_google_id',
                    'endorser.name as endorser_name', 's.title as skill_title', 'ses.endorsement_status_id')
            ->get();
        ...
        $achievementResponses = DB::table('achievement_endorsement_statuses as aes')
            ...
            ->select('aes.id', 'aes.updated_at as created_at', 'endorser.google_id as endorser_google_id',
                    'endorser.name as endorser_name', 'a.title as achievement_title', 'a.issued_by', 'aes.endorsement_status_id')
            ->get();
        ...
        $collaborationResponses = DB::table('project_collaborator_invitation_statuses as pcis')
            ...
            ->select('pcis.id', 'pcis.updated_at as created_at', 'collaborator.google_id as collaborator_google_id',
                    'collaborator.name as collaborator_name', 'p.title as project_title', 'pcis.project_collab_status_id')
            ->get();
